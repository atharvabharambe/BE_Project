...
let docsRequired = ["Aadhar", "Pan Card", "Passport", "Voter Id"];
...
export function ProfilePage() {
  ...
  useEffect(() => {
    if (fileUrl !== "") {
      console.log("8181818181818181818181818181818181818181818181818181818181");
  ...
  function handleDelete(id: string) {
    console.log("9797979797979797979797979797979797979797979797979797979797");
  ...
  function handlefirstDocImage(id: string) {
    console.log("116116116116116116116116116116116116116116116116116116")
    setDocument(allDocs.find((i) => i.id === id)?.type || "");
  ...
  useEffect(() => {
    setDocList(() => {
      console.log(`allDocs start 1111111`)
      console.log(allDocs)
      console.log(`allDocs end 1111111`)
  ...
  const uploadToIpfs = async () => {
    ...
    const cid = await upload(jsonData);
    if (cid) {
      updateDatahash(cid);
      ...
      (async () => {
        try {
          ...
          const result: any = await fetch(
            `https://ipfs.io/ipfs/${myData.dataHash}`
          );

          //  console.log("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
          //console.log(result);
          //  console.log("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
          //console.log("157157157157157157157157157157157157157157157157157157157");

          if (result) {
            const docsData = Array.of(
              {
            ...
            setAllDocs(docsData);
            console.log(`allDocs start 2222222`)
            console.log(allDocs)
            console.log(`allDocs end 2222222`)
          } else {
